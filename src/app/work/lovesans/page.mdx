...
import imageSpecimenFamily from './specimen-family.svg'
import imageSpecimenCharacters from './specimen-characters.svg'
import imageSpecimenWeb from './specimen-web.png'
import imageSpecimenUi from './specimen-ui.png'
import imageSpecimenItalic from './specimen-italic.svg'
...
<img src={imageSpecimenFamily.src} alt="LoveSans family overview" />
...
<img src={imageSpecimenCharacters.src} alt="LoveSans character set" />
...
<img src={imageSpecimenItalic.src} alt="LoveSans italic system" />
...
<img src={imageSpecimenWeb.src} alt="LoveSans website application" />
...
<img src={imageSpecimenUi.src} alt="LoveSans UI application" />

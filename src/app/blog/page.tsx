...
export default async function Blog() {
  ...
  return (
    <RootLayout>
      <PageIntro eyebrow="Blog" title="Insights on design and development.">
        <p>
          Thoughts, tutorials, and deep dives on building scalable digital
          products. Explore our latest articles on Next.js, Webflow, and modern
          UI/UX design.
        </p>
      </PageIntro>
          ...
          <FadeIn>
            <Border className="pt-16">
              <p className="max-w-2xl text-base text-neutral-600">
                No public articles yet. New posts are coming soon.
              </p>
            </Border>
          </FadeIn>
        )}
